...
export default InjectI18N(class TaskError extends React.Component {
  ...
  render() {
    ...
    } else if (this.props.errorCode === 'CANT_RECONCILE') {
      message = this._('The selected Task is not in a state that allows Reconciliation.');
