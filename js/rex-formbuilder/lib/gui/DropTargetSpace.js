...
const ElementWorkspaceTarget = {
  ...
  hover(props, monitor, component) {
    ...
    DraftSetActions.putElement(item.element, null);
    return;
  }
};
...
export default DropTarget(
  ...
  ElementWorkspaceTarget,
  collect
)(
  class DropTargetSpace extends React.Component {
    render() {
      let { connectDropTarget } = this.props;
      return connectDropTarget(<div className="drop-target" />);
    }
  }
);
