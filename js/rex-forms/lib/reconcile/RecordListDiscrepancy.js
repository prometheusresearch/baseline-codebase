...
let RecordListRecordDiscrepancy = inject(function({
  formValue,
  id,
  discrepancy,
  entries,
  ...
  Object.keys(discrepancy)
    .filter(field => field != "_NEEDS_VALUE_")
    .forEach(field => {
  ...
  return (
    ...
    >
      ...
      {formValue.completeErrorList.length > 0 && (
        <ReactUI.Block paddingStart="x-small" paddingBottom="x-small">
