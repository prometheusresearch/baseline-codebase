...
export let IconPlus = makeIconFromUnicodeSymbol({
  displayName: "IconPlus",
  symbol: "＋"
});
export let IconSum = makeIconFromUnicodeSymbol({
  displayName: "IconSum",
  symbol: "∑"
});
export let IconDiv = makeIconFromUnicodeSymbol({
  displayName: "IconDiv",
  symbol: "/"
});
export let IconPencil = makeIconFromUnicodeSymbol({
  displayName: "IconDiv",
  symbol: "✏"
});
