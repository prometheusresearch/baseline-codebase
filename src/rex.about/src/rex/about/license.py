...
supplemented by additional terms according to section 7 of the AGPL:</p>

<p>This Program was created by Prometheus Research and other contributors
to the RexDB Platform (<a href="http://rexdb.org">http://rexdb.org</a>).
As permitted by section 7b
...
include a graphical logo for this and other software programs.</p>

<p>For works containing this Program or any covered work, each interactive
...
otherwise, a textual equivalent is permitted.</p>
...
<p>Additional permissions, which may be removed at your option, under
GNU AGPL version 3 section 7:</p>
...
permission to convey the entire combined work containing those parts.</p>
'''
