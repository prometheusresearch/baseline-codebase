...
var Autocomplete = React.createClass({
  ...
  render() {
    var className = cx(
      ...
      this.state.showResults ?
        ...
        undefined,
      this.props.dropUp ? 
        'react-autocomplete-Autocomplete--dropUp':
        undefined
    );
    var style = {
      position: 'relative',
    ...
    return (
      <div
        ...
        onBlur={this.onBlur}
        style={style}>
        {this.props.dropUp ? resultsElement : inputElement}
        {this.props.dropUp ? inputElement : resultsElement}
      </div>
    );
  },
  ...
  componentWillReceiveProps(nextProps) {
    var srcId = this.props.value ? this.props.value.id : null;
    var newId = nextProps.value ? nextProps.value.id : null;
    if (newId != srcId) {
