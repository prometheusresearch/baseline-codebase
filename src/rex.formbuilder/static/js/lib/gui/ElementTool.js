...
const elementToolSource = {
  ...
  endDrag(props, monitor, component) {
    if (!monitor.didDrop()) {
      ...
      let cfg = component.state.pendingElement.constructor
...
@DragSource(ELEMENT_TYPE, elementToolSource, collect)
export default class ElementTool extends React.Component {
