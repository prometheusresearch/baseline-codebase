...
import {
  here, pipeline, select, navigate, def, filter, value,
  inferType,
} from '../Query';
...
describe('remove()', function() {
  ...
  it('individual.name!', function() {
    ...
    expect(strip(remove({loc: loc(query, focusQuery)})))
      .toEqual(strip(expectedQuery));
  });
...
describe('growNavigation()', function() {
  ...
  it('grows a on here', function() {
    ...
    let path = ['a'];
    expect(strip(growNavigation({loc: loc(query, here), path})))
      .toEqual(strip(expectedQuery));
  });
  ...
  it('grows b.c on here:select(a := [a])', function() {
    ...
    let path = ['b', 'c'];
    expect(strip(growNavigation({loc: loc(query, focusQuery), path})))
      .toEqual(strip(expectedQuery));
  });
...
describe('reconcileNavigation()', function() {
  ...
  it('individual', function() {
    ...
    expect(strip(reconcileNavigation(inferType(domain, query))))
      .toEqual(strip(expectedQuery));
  });
