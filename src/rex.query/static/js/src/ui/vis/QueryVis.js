...
export function QueryVisGroupButton({query, ...rest}: {
  query: GroupQuery,
  selected: ?QueryAtom,
}) {
  return (
...
export function QueryVisAggregateButton({query, ...rest}: {
...
function QueryVisPipeline({pipeline, closeable, isTopLevel, activeQueryPipeline, ...props}: {
