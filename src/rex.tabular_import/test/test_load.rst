...
When inserting empty values into required fields, it will complain::
    ...
    >>> import_tabular_data('required_tests', TEST_REQMISSING_CSV, FILE_FORMAT_CSV)
    Traceback (most recent call last):
        ...
    TabularImportError: Errors occurred while importing the records
...
not have a default value::
    ...
    >>> import_tabular_data('required_tests', TEST_REQMISSING_CSV, FILE_FORMAT_CSV, use_defaults=True)
    Traceback (most recent call last):
        ...
    TabularImportError: Errors occurred while importing the records
        1: Got an error from the database driver: null value in column "is_required" violates not-null constraint
...
complain::
    ...
    >>> import_tabular_data('unique_tests', TEST_UNIQUE_BAD_CSV, FILE_FORMAT_CSV)
    Traceback (most recent call last):
        ...
    TabularImportError: Errors occurred while importing the records
...
blah::
    ...
    >>> import_tabular_data('branch', TEST_BRANCHBADUNIQ_CSV, FILE_FORMAT_CSV)
    Traceback (most recent call last):
        ...
    TabularImportError: Errors occurred while importing the records
