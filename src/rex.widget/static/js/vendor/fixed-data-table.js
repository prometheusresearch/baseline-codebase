...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedDataTableColumn = React.createClass({
	  ...
	  propTypes: {
	     ...
	     */
	    dataKey: PropTypes.oneOfType([PropTypes.string, PropTypes.number, PropTypes.array]).isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedDataTableCell = React.createClass({
	  ...
	  propTypes: {
	     ...
	     */
	    cellDataKey: PropTypes.oneOfType([PropTypes.string.isRequired, PropTypes.number.isRequired, PropTypes.array.isRequired]),
